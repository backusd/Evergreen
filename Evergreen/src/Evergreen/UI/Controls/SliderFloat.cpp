...
{ 
	if (m_value != value)
	{
		...
		SliderFloatValueChangedEvent _e(m_value);
		HandleOnValueChanged(_e);
	}
}
...
void SliderFloat::MouseMoveHandledByPane(MouseMoveEvent& e)
{
