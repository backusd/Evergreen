...
public:
	...
	ND std::string ToString() const noexcept override { return std::format("SliderIntValueChangedEvent: {}", m_value); }
	...
	ND static EventType GetStaticType() noexcept { return EventType::None; }
	ND virtual EventType GetEventType() const noexcept override { return GetStaticType(); }
	ND virtual const char* GetName() const noexcept override { return "SliderIntValueChanged"; }
